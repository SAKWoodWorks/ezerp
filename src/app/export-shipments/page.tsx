/**
 * Export Shipments List Page
 * หน้ารายการส่งออกสินค้า (ไม้สักไปต่างประเทศ)
 *
 * This page displays all export shipments to international markets
 * หน้านี้แสดงรายการส่งออกสินค้าไปต่างประเทศทั้งหมด
 */
...
import { getExportShipments } from "./actions"
...
export default async function ExportShipmentsPage() {
  ...
  // Fetch all export shipments / ดึงข้อมูลการส่งออกทั้งหมด
  ...
  return (
    <div className="container mx-auto py-6">
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <Button asChild>
          <Link href="/export-shipments/new">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {shipments.filter((s) => s.status === "ready").length}
            </div>
          </CardContent>
        </Card>
        <Card>
      ...
      {/* Shipments Table / ตารางรายการส่งออก */}
      <Card>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>{t("estimatedDeparture")}</TableHead>
              ...
              <TableBody>
                {shipments.map((shipment) => (
                  <TableRow key={shipment.id}>
                    <TableCell>
                      <Link
                        href={`/export-shipments/${shipment.id}`}
