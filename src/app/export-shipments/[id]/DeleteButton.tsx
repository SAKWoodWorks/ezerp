/**
 * Delete Button Component for Export Shipments
 * ปุ่มลบสำหรับการส่งออกสินค้า
 *
...
import { deleteExportShipment } from "../actions"
...
export function DeleteButton({ id }: Props) {
  ...
  const t = useTranslations("ExportShipments")
